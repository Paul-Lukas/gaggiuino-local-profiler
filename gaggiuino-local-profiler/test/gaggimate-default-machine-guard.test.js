...
describe('GaggiMate as default machine — Gaggiuino HTTP paths must not fire', () => {
    ...
    beforeEach(() => {
        ...
        // Seed default machine as type gaggimate. The poll/sync modules
        // re-require a fresh registry (bound to memDb) on their own load
        // below, so no explicit registry require is needed here.
        memDb.prepare(
