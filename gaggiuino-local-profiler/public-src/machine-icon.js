...
// jug, and a mini shot-curve baked into the on-machine display. The plain
// machineIconSvg()/machineIconMiniSvg() above are untouched and keep
// serving the static settings-screen previews.
//
...
function animBody(gradId, steelId) {
    return `
