...
|---|---|---|---|---|
| gaggiuino-local-profiler | 2026-05-20 | 2026-08-04 | 757 | 561 (74%) |
...
| **Combined** | **2026-05-20** | **2026-08-04** | **1117** | **820 (73%)** |

![Commits per repo](docs/dev-stats/commits-per-repo.png)

Combined line changes (insertions + deletions across all commits): **312.562**, of which **233.639** landed in Claude-co-authored commits.
...
**Estimated cost: ~$33.83** across 228.400 priced lines (+ 5.239 lines from unpriced models, excluded from this total).
